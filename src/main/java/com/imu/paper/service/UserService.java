package com.imu.paper.service;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;

import com.imu.paper.VO.UserVO;
import com.imu.paper.entity.ServiceRequest;
import com.imu.paper.entity.User;
import com.imu.paper.mapper.UserMapper;
...
public class UserService {
    ...
    public Map<String, Object> register(ServiceRequest serviceRequest){
        ...
        String userPassword = String.valueOf(serviceRequest.getParam().get("user_password"));
        String userEmail = String.valueOf(serviceRequest.getParam().get("user_email"));
        userMapper.registerUser(userName, userPassword, userEmail);
        result.put("msg","注册成功!");
        return result;
    }
